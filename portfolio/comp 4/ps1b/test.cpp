...
BOOST_AUTO_TEST_CASE(testValidateSeed) {
    // Valid 16-bit binary string
    BOOST_REQUIRE_EQUAL(PhotoMagic::validateSeed("1010101010101010"), "1010101010101010");

    // Invalid inputs
    BOOST_CHECK_THROW(PhotoMagic::validateSeed("abc"), std::invalid_argument);
    BOOST_CHECK_THROW(PhotoMagic::validateSeed("0101010101010101010"), std::invalid_argument);
    BOOST_CHECK_THROW(PhotoMagic::validateSeed("01010101010101a1"), std::invalid_argument);
    BOOST_CHECK_THROW(PhotoMagic::validateSeed("010101"), std::invalid_argument);
}
